...
![package filtering story map](../images/package_filtering/secure_story_map.jpg)
...
![package filtering admin UI](../images/package_filtering/admin.png)
...
![terminal showing a blocked package](../images/package_filtering/policy_violations.png)
