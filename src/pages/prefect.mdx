...
People said they missed the original data visualization on this page, which we had dubbed "The Ball Pit".
...
Rather than shipping a mediocre experience, I revisited the core observability problems that users have, including problems that even the Ball Pit _doesn't_ solve.
