...
- I then built out low-fidelity exploratory prototypes in Figma, sharing explorations daily in Slack we converged on a design that felt conceptually sound and that satisfied the original requirements.
