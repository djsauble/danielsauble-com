...
I currently work at <a href="https://iterative.ai" target="_blank">Iterative</a> on MLOps tools
and am also a teaching faculty for an advanced machine learning class (CSCI E-82) at the Harvard
Extension School. More details in my <Link to="/resume">resume</Link>.
...
<ProjectHero
  to="/vector_db"
  title="DataStax Astra DB docs"
  description="Documentation for a vector database"
>
