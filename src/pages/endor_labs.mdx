...
import ProjectOverviewImg from "../images/endor_labs/01_project_overview.png"
import CIRunsImg from "../images/endor_labs/02_ci_runs.png"
import CreatePolicyActionImg from "../images/endor_labs/03_create_policy_action.png"
import FindingsCallPathsDrawerImg from "../images/endor_labs/04_findings_call_paths_drawer.png"
import DependencyGraphImg from "../images/endor_labs/05_dependency_graph.png"
import UserJourneyMapImg from "../images/endor_labs/06_user_journey_map.png"
import ConceptualPrototypeImg from "../images/endor_labs/07_conceptual_prototype.png"
import DataVizExplorationImg from "../images/endor_labs/08_data_viz_exploration.png"
import ResearchResultsMatrixImg from "../images/endor_labs/09_research_results_matrix.png"
...
This is a sample of work from my role as the founding product designer at Endor Labs, a dependency lifecycle management tool for software developers and application security people. I have owned the design of our first product from conception (March 2022) to launch (October 2022), to our first few customers (January 2023-).
...
<img src={ProjectOverviewImg} alt="Project Overview Dashboard UI" />

## Project scan history with CI status

Endor Labs performs static analysis of code. This scanned data is uploaded to our service and the history can be viewed in the UI. Depending on how policy is configured, these scans may block the company’s CI pipeline until any violations are resolved.

<img src={CIRunsImg} alt="Project CI Runs UI" />
...
<img src={CreatePolicyActionImg} alt="Create Policy Action UI" />
...
<img src={FindingsCallPathsDrawerImg} alt="Findings / Call Paths Drawer UI" />
...
<img src={DependencyGraphImg} alt="Dependency graph UI" />
...
<img src={UserJourneyMapImg} alt="Early user journey map" />
...
<img src={ConceptualPrototypeImg} alt="Early conceptual prototype" />

## Early data viz exploration

We realized early on that a product with nothing but tables was likely to have limited utility. As our data collection efforts continued, we began to see interesting trends, graphs, and rollups that needed to be shown in a non-tabular representation. I began to explore different ways to visualize this data in the UI and even though these early attempts were wrong, they facilitated great discussions that helped us understand the limitations of the data (especially with regards to trends) and the feasibility of different data visualizations.

<img src={DataVizExplorationImg} alt="Early data viz exploration" />
...
<img src={ResearchResultsMatrixImg} alt="Usability research results matrix" />