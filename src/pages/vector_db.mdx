...
import OldLandingPage from "../images/vector_db/00_old_landing_page.png"
import NewLandingPage from "../images/vector_db/01_new_landing_page.png"
import NewQuickstartPage from "../images/vector_db/02_new_quickstart_page.png"
...
<img src={OldLandingPage} alt="Old serverless docs landing page" class="border" />
...
<img src={NewLandingPage} alt="Old serverless docs landing page" class="border" />

<img src={NewQuickstartPage} alt="Old serverless docs landing page" class="border" />